...
The event log is the source of truth. Every meaningful runtime action
is an event. This page is the wire-format reference.
...
Payloads are CBOR-encoded structs. The full definitions are in
[`event/types.go`](https://github.com/jerkeyray/starling/blob/main/event/types.go);
the highlights:
